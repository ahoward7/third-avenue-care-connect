<template>
  <svg
    ...
    viewBox="0 0 24 24"
  >
    <rect width="10" height="10" x="1" y="1" class="fill-green" rx="1">
    ...
    <rect width="10" height="10" x="1" y="13" class="fill-purple" rx="1">
    ...
    <rect width="10" height="10" x="13" y="13" class="fill-yellow" rx="1">
